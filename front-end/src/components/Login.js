  ...
  return (
    ...
    <div className="flex-container">
      <div className="welcome">
        <img className= "welcome-img" src="https://i.imgur.com/oAFz2Qm.png" alt="welcome-img" onMouseEnter={(e) => imageHoverEnter(e)} onMouseLeave={(e) => imageHoverExit(e)}/>
      </div>
      ...
      <div className="login-form-container">
        ...
        <div className="login-form-content-bottom">
          <form className= "sign-up-form" onSubmit={onSignupSubmit}>
            <input className="form-inputs" placeholder=" First and Last Name"type="text" value={nameSign} 
              onChange={e => setNameSign(e.target.value)}>
            </input>
            <input className="form-inputs" placeholder=" Username" type="text" value={userSign} 
              onChange={e => setUserSign(e.target.value)}>
            </input>
            <input className="form-inputs" placeholder=" Password" type="password" value={passSign} 
